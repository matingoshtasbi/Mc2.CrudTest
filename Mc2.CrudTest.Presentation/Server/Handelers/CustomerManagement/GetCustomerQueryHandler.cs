...
{
    internal class GetCustomerQueryHandler : IRequestHandler<GetCustomersQuery, CustomerVM>
    {
        #region member
        ...
        #region constractor
        public GetCustomerQueryHandler(ICustomerManagementQueryService queryService)
        {
            _queryService = queryService;
        }

        public Task<CustomerVM> Handle(GetCustomersQuery request, CancellationToken cancellationToken)
        {
            return _queryService.FindEmployee(request.Id);
        }
        #endregion
